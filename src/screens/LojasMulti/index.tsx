  ...
  const [citys, setCitys] = useState([
    {
      id: '0', name: 'Bento Gonçalves', active: true, shopps: [
        ...
        { id: '1', statusMap: false, name: 'Multi Lugana', address: 'Rua José Rossini, nº 370, Bairro Santa Helena, Bento Gonçalves - RS', hours: 'Segunda à Sexta : 8h às 20h, Sábado: 9h às 20h, Domingo: 9h às 12h', phone: '(54) 99714-4666', url: 'images/multiLugama.jpg' },
        { id: '2', statusMap: false, name: 'Multi Maxi Compra', address: 'Rua Jose Rosinni n 340', hours: 'Segunda a sexta: 8h as 22h', phone: '(54) 99714-4666', url: 'images/multiLugama.jpg' }]
    },
